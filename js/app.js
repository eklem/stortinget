...
if ("serviceWorker" in navigator) {
  ...
  navigator.serviceWorker.register(window.location.origin + window.location.pathname + 'js/service-worker.js', { scope: window.location.origin + window.location.pathname + 'js/'}).then (
    (registration) => {
